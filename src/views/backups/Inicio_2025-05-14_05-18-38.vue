    ...
    <ion-header>
      <ion-toolbar>
        <ion-title class="header-title">
          <div class="title-gradient">Aura Producciones - Radio Stream</div>
        </ion-title>
      </ion-toolbar>
    </ion-header>
          ...
          <div class="stats-grid">
            ...
            <article class="stat-card health-card">
              ...
              <div class="connection-quality">
                <div v-for="n in 3" :key="n" class="quality-bar" :style="`--bar-width: ${30 + n * 20}%`"></div>
              </div>
            </article>
          </div>
        </section>
...
.gradient-overlay {
  ...
  width: 100%;
  height: 100%;
  background: linear-gradient(45deg, rgba(106, 17, 203, 0.1), transparent 60%);
  pointer-events: none;
}
