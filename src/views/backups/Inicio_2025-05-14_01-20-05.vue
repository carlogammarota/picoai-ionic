    ...
    <ion-content :fullscreen="true" color="dark">
      <section class="live-banner ion-padding">
        <ion-card mode="ios" color="medium-dark">
          ...
          <ion-card-content class="ion-text-center">
            ...
            >
              <i class="fas fa-play-circle" slot="start"></i>
              Escuchar en Vivo
            </ion-button>
            ...
            >
              <ion-card mode="ios" color="medium-dark">
                ...
                <ion-card-content>
                  ...
                  >
                    Ver más
                    <i class="fas fa-arrow-right" slot="end"></i>
                  </ion-button>
                </ion-card-content>
              </ion-card>
            </ion-col>
      ...
      <section class="social-section ion-padding">
        ...
        <div class="ion-text-center ion-padding">
          ...
          >
            <i :class="social.icon" slot="icon-only"></i>
          </ion-button>
        </div>
      </section>
    </ion-content>
...
const socialLinks = ref([
  { name: 'Instagram', icon: 'fab fa-instagram', color: 'instagram' },
  { name: 'TikTok', icon: 'fab fa-tiktok', color: 'tiktok' },
  { name: 'Patreon', icon: 'fab fa-patreon', color: 'patreon' },
  { name: 'Spotify', icon: 'fab fa-spotify', color: 'spotify' }
]);

const tabs = ref([
  { name: 'inicio', route: '/inicio', icon: 'fas fa-home', label: 'Inicio', selected: true },
  { name: 'programas', route: '/programas', icon: 'fas fa-list', label: 'Programas' },
  { name: 'en-vivo', route: '/en-vivo', icon: 'fas fa-broadcast-tower', label: 'En Vivo' },
  { name: 'contacto', route: '/contacto', icon: 'fas fa-envelope', label: 'Contacto' }
]);
</script>
